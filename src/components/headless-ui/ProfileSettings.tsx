        ...
        <>
          <Popover.Button
            className={`
                ...
                inline-flex items-center justify-center p-2 rounded-md hover:bg-black/10 focus-visible:ring-2 focus:outline-none focus-visible:ring-black/10`}
          >
            <img
              src={threePointsMenu}
          ...
          >
            <Popover.Panel className="absolute z-10 w-[13rem] mt-2 transform -translate-x-1/2 -left-[125%] rounded-md bg-gray-400 p-2 shadow-2xl">
              <div className="flex items-center gap-2 px-2 py-1 mt-1 text-gray-200 rounded-md cursor-pointer hover:bg-black/20">
                {/* {post ? <EditPostDialog post={post} uploads={uploads} /> : null} */}
                <p className="text-gray-200">Password and security</p>
              </div>
